...
/// From source file: {1}
/// </summary>", assemblyDefinition, cSharpSource)));
        }
        ...
        private static bool StripPropertyBody(ref AccessorDeclarationSyntax syntax)
        {
            ...
            if(syntax.Body != null)
            {
                syntax = syntax.RemoveNode(syntax.Body, SyntaxRemoveOptions.KeepEndOfLine);
                hasBody = true;
            }
            ...
            {
                syntax = syntax.RemoveNode(syntax.ExpressionBody, SyntaxRemoveOptions.KeepEndOfLine);
                hasBody = true;
            }
