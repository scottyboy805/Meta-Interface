...
namespace DLCToolkit.DRM
{
    ...
    public sealed class LocalDirectoryDRM : IDRMProvider
    {
        ...
        public LocalDirectoryDRM(string localFolderPath)
        {
            ...
            {
                Debug.LogError("Could not use local folder as DRM source location: " + e);
            }
        }
        ...
        DLCAsync<string[]> IDRMProvider.GetDLCUniqueKeysAsync(IDLCAsyncProvider asyncProvider)
        {
            ...
            if (directory == null)
                return DLCAsync<string[]>.Completed(true);

            return DLCAsync<string[]>.Completed(true, directory.GetDLCUniqueKeys());
        }
        ...
        DLCAsync IDRMProvider.IsDLCAvailableAsync(IDLCAsyncProvider asyncProvider, string uniqueKey)
        {
            ...
            return DLCAsync.Completed(directory.HasDLC(uniqueKey));
        }
